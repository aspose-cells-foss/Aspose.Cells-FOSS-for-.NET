...
namespace Aspose.Cells_FOSS
{
    internal static class XlsxDocumentProperties
    {
        ...
        internal static void LoadDocumentProperties(ZipArchive archive, WorkbookModel model, LoadDiagnostics diagnostics, LoadOptions options)
        {
            ...
            string resolvedCorePropertiesPartUri;
            if (relationshipTargets.TryGetValue(CorePropertiesRelationshipType, out resolvedCorePropertiesPartUri)
            ...
            string resolvedExtendedPropertiesPartUri;
            if (relationshipTargets.TryGetValue(ExtendedPropertiesRelationshipType, out resolvedExtendedPropertiesPartUri)
        ...
        private static int? ReadIntElement(XElement parent, XName name, LoadDiagnostics diagnostics, LoadOptions options, string partUri)
        {
            ...
            int value;
            if (int.TryParse(element.Value, NumberStyles.Integer, CultureInfo.InvariantCulture, out value) && value >= 0)
            {
                return value;
            }
