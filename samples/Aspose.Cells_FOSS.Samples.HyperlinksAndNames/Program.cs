...
namespace Aspose.Cells_FOSS.Samples.HyperlinksAndNames
{
    internal static class Program
    {
        private static void Main()
        {
            ...
            var mailLink = linksSheet.Hyperlinks[linksSheet.Hyperlinks.Add("C4", "D5", "mailto:test@example.com", "Mail", "Send mail")];
            mailLink.ScreenTip = "Send mail";
            ...
            Console.WriteLine("Local name scope: " + GetSheetIndexOrDefault(loaded.DefinedNames[1].LocalSheetIndex));
        }

        private static int GetSheetIndexOrDefault(int? localSheetIndex)
        {
